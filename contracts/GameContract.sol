...
contract GameContract {
    ...
    function Playerpart(uint256 tokenid) public {
        ...
        if (Games[gameid].party0 == address(0) && Games[gameid].party1 == address(0)){
            ...
            uint num = block.number < Games[gameid-1].startblock+20 ?  Games[gameid-1].startblock+20:block.number;
    ...
    function claimnft(uint tokenid,uint gameId) public {
        require(tx.origin == Games[gameId].party0 || tx.origin == Games[gameId].party1 );
